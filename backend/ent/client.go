...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.UserPlatformQuota, c.UserResourceOverride, c.UserSubscription,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		...
		UserResourceOverride, UserSubscription []ent.Hook
	}
	inters struct {
		APIKey, Account, AccountGroup, Announcement, AnnouncementRead, AuthIdentity,
		AuthIdentityChannel, BatchImageEvent, BatchImageItem, BatchImageJob,
		...
		UsageCleanupTask, UsageLog, UsageLogDetail, User, UserAllowedGroup,
		UserAttributeDefinition, UserAttributeValue, UserPlatformQuota,
		UserResourceOverride, UserSubscription []ent.Interceptor
	}
)
