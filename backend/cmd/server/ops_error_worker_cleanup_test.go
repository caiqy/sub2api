...
func TestProvideCleanupDrainsOpsErrorsBeforeEntTeardown(t *testing.T) {
	...
	cleanup := provideCleanup(
		...
		service.NewAccountExpiryService(nil, time.Second), nil, nil, service.NewProxyExpiryService(nil, time.Second), service.NewSubscriptionExpiryService(nil, time.Second),
