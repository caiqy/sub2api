...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	settingService := service.ProvideSettingServiceWithUsageLogPruner(settingRepository, groupRepository, proxyRepository, configConfig, httpUpstream, usageLogRepository)
	...
	accountTestService := service.NewAccountTestService(accountRepository, geminiTokenProvider, claudeTokenProvider, grokTokenProvider, openAITokenProvider, antigravityGatewayService, httpUpstream, configConfig, tlsFingerprintProfileService)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, apiKeyService, subscriptionService, opsService, userService, settingService, redisClient)
	...
	userPlatformQuotaUsageFlusher := service.NewUserPlatformQuotaUsageFlusher(configConfig, billingCache, serviceUserPlatformQuotaRepository, timingWheelService)
