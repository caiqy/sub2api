...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	rateLimitCacheInvalidator := service.ProvideRateLimitCacheInvalidatorFromBillingCache(billingCache)
	apiKeyService := service.ProvideAPIKeyService(apiKeyRepository, userRepository, groupRepository, userSubscriptionRepository, userGroupRateRepository, apiKeyCache, configConfig, rateLimitCacheInvalidator)
