...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	settingService := service.ProvideSettingService(settingRepository, groupRepository, configConfig, httpUpstream)
	...
	soraS3Storage := service.ProvideSoraS3StorageWithRefresh(settingService)
