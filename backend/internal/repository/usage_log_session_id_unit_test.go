...
// is four positions before the end (the two body sizes precede created_at).
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 61, "arg-type table must include session_id and body sizes")
