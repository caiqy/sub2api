...
func (s *OpenAIGatewayService) ForwardEmbeddings(
	...
	if resp.StatusCode >= 400 {
		...
		if s.shouldFailoverOpenAIUpstreamResponse(resp.StatusCode, upstreamMsg, respBody) {
			...
			return nil, &UpstreamFailoverError{StatusCode: resp.StatusCode, ResponseHeaders: responseHeaders, ResponseBody: respBody, RetryableOnSameAccount: retryableOnSameAccount}
		}
