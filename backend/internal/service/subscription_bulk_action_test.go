...
func (r *bulkActionSubscriptionRepo) ResetUsageWindowsWithVersion(ctx context.Context, id int64, daily, weekly, monthly bool, dailyStart, periodicStart time.Time) (int64, error) {
