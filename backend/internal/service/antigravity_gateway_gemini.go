...
func (s *AntigravityGatewayService) forwardGeminiHandle(ctx context.Context, c *gin.Context, account *Account, originalModel string, action string, stream bool, bodyHandle *RequestBodyHandle, isStickySession bool, options ...ForwardGeminiOption) (*ForwardResult, error) {
	...
	injectedBody, extraHeaders, err := applyAntigravityPassthrough(ctx, c, account, body, injectedBody)
	if err != nil {
...
func (s *AntigravityGatewayService) ForwardGeminiHandle(ctx context.Context, c *gin.Context, account *Account, originalModel, action string, stream bool, bodyHandle *RequestBodyHandle, isStickySession bool, options ...ForwardGeminiOption) (*ForwardResult, error) {
	if bodyHandle == nil {
