...
func TestAPIKeyService_RejectsV24AuthSnapshotWithoutForkProjection(t *testing.T) {
	groupID := int64(9)
	svc := &APIKeyService{}
	...
	if ok {
		t.Fatalf("expected upstream v24 auth snapshot to be rejected after fork fields were added")
	}
	if apiKey != nil {
