...
func (s *accountRepoStub) ListTempUnschedulableByPlatform(ctx context.Context, platform string, now time.Time) ([]Account, error) {
	panic("unexpected ListTempUnschedulableByPlatform call")
}
