...
func (r *usageBatchLogRepoStub) PersistDetailBestEffort(context.Context, *UsageLog) {}
func (r *usageBatchLogRepoStub) GetByID(context.Context, int64) (*UsageLog, error) {
	return nil, nil
}
func (r *usageBatchLogRepoStub) GetDetailByUsageLogID(context.Context, int64) (*UsageLogDetail, error) {
