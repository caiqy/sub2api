...
func newAstraProFailoverContext(t *testing.T, body string) (*gin.Context, *httptest.ResponseRecorder) {
	...
	c.Request = c.Request.WithContext(service.WithEffectiveGatewayRoute(c.Request.Context(), service.EffectiveGatewayRoute{
		APIKey: apiKey, Group: apiKey.Group, GroupID: apiKey.GroupID,
		ClientModel: "gpt-6-astra", RoutingModel: "gpt-6-astra", UpstreamModel: "gpt-6-astra", Platform: service.PlatformOpenAI,
	}))
	return c, rec
}
