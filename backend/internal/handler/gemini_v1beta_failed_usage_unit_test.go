...
func TestGatewayHandler_GeminiV1BetaModels_ForwardErrorStillCreatesUsageLog(t *testing.T) {
	...
	h := NewGatewayHandler(gatewayService, nil, geminiCompatService, nil, nil, concurrencyService, billingCacheService, nil, &service.APIKeyService{}, nil, nil, nil, nil, cfg, nil, nil)
