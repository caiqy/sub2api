...
- [ ] 1.1 在 Comet 确认的隔离位置记录不可变 source base、仅允许包含当前 change 规划产物的 execution base、`VERSION=0.1.165.4`，以及 `v0.1.166`、`v0.1.168`、`v0.1.169` 的 peeled SHA 和严格祖先链；除 Comet runtime selection 外的 dirty path 必须阻塞
