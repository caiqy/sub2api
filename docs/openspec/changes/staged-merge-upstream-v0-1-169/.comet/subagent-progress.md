...
- 映射 OpenSpec: 2.3
- 阶段: `task-8 / fix-round-3-re-review-dispatch-intent`
...
- Task-8 fix-3 re-review task ID: `pending resumed functions.task return`
- Task-8 review-fix rounds: `3/5 reviewing`
...
- 状态: Task8 docs-only fix round 3 scoped re-review即将派发，Task9不得运行。
