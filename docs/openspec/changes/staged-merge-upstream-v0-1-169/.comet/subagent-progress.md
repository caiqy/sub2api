...
- 映射 OpenSpec: 2.3
- 阶段: `task-8 / closure-rerun-dispatch-intent`
...
- Task-8 closure task ID: `pending resumed functions.task return`
...
- 状态: Task8 compatibility fix loop review clean；full closure rerun即将派发，Task9不得运行。
