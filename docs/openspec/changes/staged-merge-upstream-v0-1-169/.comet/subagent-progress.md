...
- 映射 OpenSpec: 2.3
- 阶段: `task-8 / fix-round-2-re-review-dispatch-intent`
...
- Task-8 fix-2 re-review task ID: `pending resumed functions.task return`
- Task-8 review-fix rounds: `2/5 reviewing`
...
- 状态: Task8 fix round 2 scoped re-review即将派发；Task8 closure与Task9不得运行。
