...
- 映射 OpenSpec: 2.3
- 阶段: `task-8 / fix-round-1-resume-3-dispatch-intent`
...
- Task-8 fix-1 resume-3 task ID: `pending resumed functions.task return`
...
- 状态: Task8 panel最小test修复已批准；即将恢复fix round 1提交并复跑，Task9不得运行。
