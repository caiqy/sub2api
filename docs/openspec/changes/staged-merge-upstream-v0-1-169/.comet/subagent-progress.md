...
- 映射 OpenSpec: 2.3
- 阶段: `task-8 / fix-round-1-context-analysis-dispatch-intent`
...
- Task-8 fix-1 context task ID: `pending resumed functions.task return`
...
- 状态: Task8 fix round 1只读scope分析即将派发；未澄清前不实施修复，Task9不得运行。
