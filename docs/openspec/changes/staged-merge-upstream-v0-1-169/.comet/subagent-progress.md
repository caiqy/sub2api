...
- 映射 OpenSpec: 2.3
- 阶段: `task-8 / fix-round-1-review-dispatch-intent`
...
- Task-8 fix-1 reviewer task ID: `pending atomic functions.task return`
- Task-8 review-fix rounds: `1/5 reviewing`
...
- 状态: Task8 fix round 1即将scoped review；通过后再fresh执行Task8 full closure，Task9不得运行。
