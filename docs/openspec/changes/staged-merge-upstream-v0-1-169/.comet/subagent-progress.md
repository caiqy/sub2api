...
- 映射 OpenSpec: 4.1
- 阶段: `task-12 / fix-round-2-scoped-re-review-dispatch-intent`
...
- Task-12 fix-2 re-review task ID: `pending resumed functions.task return`
...
- 状态: Task12 fix round 2 scoped re-review即将派发；Task13不得运行。
