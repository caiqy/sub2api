...
archived-with: 2026-07-17-staged-merge-upstream-v0-1-159
---
...
- [x] **步骤 1：运行完整保护门禁与 v0.1.153 定向验证**
...
- [x] **步骤 3：独立提交 v0.1.153 阶段门禁证据**

  正式报告记录完整门禁、受影响矩阵命令、九项冲突入口、生成/静态检查和 Task 11 放行结论；只提交报告 `docs: close v0.1.153 stage gate`。无完整 PASS 不得开始 v0.1.155 merge。
...
- [x] **步骤 3：独立提交 v0.1.155 阶段门禁证据**

  正式报告记录全量门禁、13 个受影响 M-ID、冲突入口、request-body matrix、生成/静态检查和 Task 14 放行结论；只提交报告 `docs: close v0.1.155 stage gate`。
...
- [x] **步骤 3：独立提交 v0.1.156 阶段门禁证据**

  canonical 报告记录完整门禁、M-01..M-15、上游超时、旧符号、生成/静态检查和 Task 19 放行结论；只提交报告 `docs: close v0.1.156 stage gate`。
