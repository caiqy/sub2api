export default {
    ops: {
      ...
      runtime: {
        ...
        metricThresholdsHint: 'Configure alert thresholds for metrics; values exceeding thresholds are displayed in red.',
        slaMinPercent: 'SLA Minimum Percentage',
        slaMinPercentHint: 'SLA below this value is displayed in red (default: 99.5%).',
        ttftP99MaxMs: 'TTFT P99 Maximum (ms)',
        ttftP99MaxMsHint: 'TTFT P99 above this value is displayed in red (default: 500ms).',
        requestErrorRateMaxPercent: 'Request Error Rate Maximum (%)',
        requestErrorRateMaxPercentHint: 'Request error rate above this value is displayed in red (default: 5%).',
        upstreamErrorRateMaxPercent: 'Upstream Error Rate Maximum (%)',
        upstreamErrorRateMaxPercentHint: 'Upstream error rate above this value is displayed in red (default: 5%).',
