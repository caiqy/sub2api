export default {
    settings: {
      ...
      gatewayRuntime: {
        title: 'Gateway Runtime Settings',
        description: 'Adjust live gateway timeouts and usage log detail retention',
        responseHeaderTimeout: 'Response header timeout (seconds)',
        responseHeaderTimeoutHint: 'Maximum time to wait for upstream response headers.',
        responseHeaderTimeoutWarning: 'Setting this too low may fail upstream requests that spend longer in a queue.',
        openAITextFirstTokenTimeout: 'Text first token timeout (seconds)',
        openAITextFirstTokenTimeoutHint: 'Only affects streaming OpenAI Responses requests; 0 disables it.',
        openAIImageFirstTokenTimeout: 'Image first token timeout (seconds)',
        openAIImageFirstTokenTimeoutHint: 'Only affects explicit image generation streaming OpenAI Responses requests; 0 disables it.',
        streamDataIntervalTimeout: 'Stream data interval timeout (seconds)',
        streamDataIntervalTimeoutHint: 'Set to 0 to disable; otherwise use 30 to 300 seconds.',
        usageLogDetailRetentionLimit: 'Standard usage log detail retention limit',
        usageLogDetailRetentionLimitHint: 'Number of standard request details retained per user; 0 retains none.',
        imageUsageLogDetailRetentionLimit: 'Image usage log detail retention limit',
        imageUsageLogDetailRetentionLimitHint: 'Number of image request details retained per user; 0 retains none.',
        ...
        validationFailed: 'Gateway runtime settings contain invalid values',
      },
      features: {
        channelMonitor: {
