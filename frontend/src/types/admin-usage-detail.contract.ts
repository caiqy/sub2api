...
// 后端 DTO 约定：headers/body 都是字符串（或 null）；body 可能是 { kind, preview, truncated, size } 快照 JSON 字符串。
const adminUsageDetailContractSample: AdminUsageDetail = {
  usage_log_id: 1,
  request_headers: '{"content-type":"application/json"}',
  request_body: '{"kind":"request_body_preview","preview":"{\\"prompt\\":\\"hello\\"}","truncated":false,"size":18}',
